...
public interface IPositionableComponent {
     ...
     *
     * @param fatherJPanel the fatherJPanel where the logo is going to be placed 120
     */
    void setLocation(@NotNull JPanel fatherJPanel, Positions position);
    /**
     * This method set the location of the logo in the center of the fatherJPanel
     *
     * @param fatherJPanel the fatherJPanel where the logo is going to be placed
     ...
     */
    void setLocation(@NotNull JPanel fatherJPanel, Positions position, int x, int y);
}
